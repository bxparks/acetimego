// Print the memory usage of acetime library when using the zonedb2000 database.
//
...
func main() {
	...
	print("---- Create ZonedDateTime using zonedb2000\n")
	zm := acetime.NewZoneManager(&zonedb2000.DataContext)
